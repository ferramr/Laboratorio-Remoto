...
class Graficador:
    ...
    def graficar_curvas_resultantes1(self,frame,t,d,modelos):
        #print("-------------------------------------")
        #print(" CLASE: Graficador")
        #print(" graficar_curvas_resultantes")
        #print("--------------------------------------")
        ...
        plt.subplot(2, 2, 1)
        plt.plot(t,model_d(t), 'r-')
        #plt.xlabel("tiempo")
        plt.ylabel("distancia [cm]")
        plt.grid()

        plt.subplot(2, 2, 2)
        plt.plot(t,model_v(t), 'b-')
        #plt.xlabel("tiempo")
        plt.ylabel("velocidad [cm/s]")
        plt.grid()

        plt.subplot(2, 2, 3)
        plt.plot(t,model_a(t), 'm-')
        plt.xlabel("tiempo")
